  ...
  return (
    <div className="min-h-screen bg-[#0A0A0F] text-white">
      ...
      <main className="mx-auto max-w-3xl px-6 pb-24 pt-32">
        ...
        <Section title="5. Ask AI (Bring Your Own Key)">
          <p>
            Klokrs offers an optional Ask AI feature that lets you connect
            your own API key from a third-party AI provider (OpenAI, Google
            Gemini, Anthropic, or OpenRouter) to ask questions about your
            tracked data. When you use this feature, your questions and
            related data are sent directly to the provider you connected,
            under your own account and API key with that provider.
          </p>
          <p>
            You are billed directly by your chosen AI provider for any usage
            — Klokrs does not charge for or profit from Ask AI usage. You are
            responsible for complying with that provider&apos;s terms of
            service, and Klokrs is not responsible for the accuracy, content,
            or availability of responses generated by a third-party AI
            provider.
          </p>
        </Section>
        ...
        <Section title="6. Billing and Subscriptions">
          <p>
            Klokrs is currently free to use. If paid plans (Standard or Pro)
            become available, payment will be processed by Stripe, and
            purchasing a subscription will be governed by additional terms
            presented at checkout, including price, billing frequency,
            cancellation, and refund policy. No feature you already use for
            free will be moved behind a paywall without advance notice.
          </p>
        </Section>
