...
function DomainRow({
  ...
  return (
    <motion.li
      ...
      className={`group flex items-center gap-3 px-4 py-3 transition-colors duration-200 sm:px-5 ${
...
export function ReportsDomainTable({
  ...
  return (
    ...
    >
      ...
      {/* Column labels */}
      <div className="hidden grid-cols-[auto_1fr_80px_64px_64px_20px] items-center gap-3 border-b border-white/[0.05] px-4 py-2 sm:grid sm:px-5">
                  ...
                  >
                    {group.subdomains
                      ...
                      .map((sub) => (
                        <li
                          key={sub.domain}
                          className="flex items-center gap-3 px-5 py-2 sm:px-6"
                        >
          ...
          <>
            <li>
              <button
                ...
                className="group flex w-full items-center gap-3 px-4 py-3 text-left transition-colors hover:bg-white/[0.03] sm:px-5"
              >
                <div className="flex shrink-0 items-center gap-3">
